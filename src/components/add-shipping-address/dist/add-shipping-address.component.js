...
var AddShippingAddressComponent = /** @class */ (function () {
    ...
    AddShippingAddressComponent.prototype.updateLocation = function () {
        var _this = this;
        this.appCoordinatesService.getCurrentLocationCoordinates().then(function (data) {
            if (data != "error") {
                _this.delivery_location = String(data.lat) + "," + String(data.long);
                _this.appToastService.toast("Location Updated");
            }
        });
    };
    AddShippingAddressComponent.prototype.ngOnInit = function () {
        ...
        this.formChangesSubscription = this.ngForm.form.valueChanges.subscribe(function (x) {
            ...
            _this.ngForm.form.value.delivery_location = _this.delivery_location;
