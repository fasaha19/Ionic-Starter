...
@Component({
  ...
  templateUrl: './product-card-style14.component.html',
  styleUrls: ['./product-card-style14.component.scss'],
})
export class ProductCardStyle14Component implements OnInit {
