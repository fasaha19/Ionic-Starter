...
@Component({
  ...
  templateUrl: './product-card-style21.component.html',
  styleUrls: ['./product-card-style21.component.scss'],
})
export class ProductCardStyle21Component implements OnInit {
