...
@Component({
  ...
  templateUrl: './product-card-style12.component.html',
  styleUrls: ['./product-card-style12.component.scss'],
})
export class ProductCardStyle12Component implements OnInit {
