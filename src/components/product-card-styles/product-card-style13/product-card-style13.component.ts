...
@Component({
  ...
  templateUrl: './product-card-style13.component.html',
  styleUrls: ['./product-card-style13.component.scss'],
})
export class ProductCardStyle13Component implements OnInit {
