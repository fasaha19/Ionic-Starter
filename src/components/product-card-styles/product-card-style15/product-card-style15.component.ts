...
@Component({
  ...
  templateUrl: './product-card-style15.component.html',
  styleUrls: ['./product-card-style15.component.scss'],
})
export class ProductCardStyle15Component implements OnInit {
