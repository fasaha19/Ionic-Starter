...
@Component({
  ...
  templateUrl: './product-card-style25.component.html',
  styleUrls: ['./product-card-style25.component.scss'],
})
export class ProductCardStyle25Component implements OnInit {
