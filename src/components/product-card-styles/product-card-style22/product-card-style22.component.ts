...
@Component({
  ...
  templateUrl: './product-card-style22.component.html',
  styleUrls: ['./product-card-style22.component.scss'],
})
export class ProductCardStyle22Component implements OnInit {
