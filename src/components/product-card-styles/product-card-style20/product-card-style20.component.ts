...
@Component({
  ...
  templateUrl: './product-card-style20.component.html',
  styleUrls: ['./product-card-style20.component.scss'],
})
export class ProductCardStyle20Component implements OnInit {
