...
@Component({
  ...
  templateUrl: './product-card-style26.component.html',
  styleUrls: ['./product-card-style26.component.scss'],
})
export class ProductCardStyle26Component implements OnInit {
