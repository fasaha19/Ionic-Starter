...
var ProductAttributesModalPageModule = /** @class */ (function () {
    function ProductAttributesModalPageModule() {
    }
    ProductAttributesModalPageModule = __decorate([
        core_1.NgModule({
            imports: [
                common_1.CommonModule,
                forms_1.FormsModule,
                angular_1.IonicModule,
                product_attributes_modal_routing_module_1.ProductAttributesModalPageRoutingModule,
