...
exports.AppCoordinatesService = void 0;
var core_1 = require("@angular/core");
var geolocation_1 = require("@capacitor/geolocation");
var AppCoordinatesService = /** @class */ (function () {
    ...
    AppCoordinatesService.prototype.getCurrentLocationCoordinates = function () {
        return __awaiter(this, void 0, void 0, function () {
            var checkPermission, coordinates, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, geolocation_1.Geolocation.checkPermissions()
                    ...
                    case 1:
                        ...
                        if (checkPermission.location != 'granted') {
                            ...
                            geolocation_1.Geolocation.requestPermissions();
                        }
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, { lat: coordinates.coords.latitude, long: coordinates.coords.longitude }];
                    case 4:
                        error_1 = _a.sent();
    ...
    AppCoordinatesService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
...
exports.AppCoordinatesService = AppCoordinatesService;
